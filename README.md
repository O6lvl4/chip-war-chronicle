...
半導体産業・政策・地政学・AI需要・市場の5系列を共通の時間軸に並べ、系列をまたぐ因果リンクと「断面」ビューで絡み合いを読むインタラクティブ・タイムライン。2018年から2026年までの出来事を、一次情報に近い出典URL付きで収録しています。
...
- 因果リンクは `src/data/links.ts` に `{ from, to, why }` で記述します。
